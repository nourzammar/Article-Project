...
<html lang="en">
  <head>
    ...
    @if (!empty($meta_keywors))
    <meta content="{{$meta_keywors}}" name="keywords" />
    @endif
    ...
    <!-- Font Awesome -->
    <link
      href="https://cdnjs.cloudflare.com/ajaxfront/libs/font-awesome/5.10.0/css/all.min.css"
      rel="stylesheet"
    />
